package happy.mjstudio.coordinatorlayoutsample.adapter

import android.os.Bundle
import androidx.fragment.app.Fragment
import androidx.fragment.app.FragmentActivity
import androidx.viewpager2.adapter.FragmentStateAdapter
import happy.mjstudio.coordinatorlayoutsample.screen.CollapsingToolbarFragment
...
class MainPageAdapter(activity : FragmentActivity) : FragmentStateAdapter(activity) {
    ...
    enum class NavigationMenu(val kClass: KClass<out Fragment>) {
        COLLAPSING_TOOLBAR(CollapsingToolbarFragment::class),
